module EDPftvarcon
  ...
  type, public ::  EDPftvarcon_type
     ...
     real(r8), allocatable :: germ_can_openness_param(:)
...
contains
  ...
  subroutine Register_PFT(this, fates_params)
    ...
    name = 'fates_seed_germ_can_openness_param'
    call fates_params%RegisterParameter(name=name, dimension_shape=dimension_shape_1d, &
         dimension_names=dim_names, lower_bounds=dim_lower_bound)
  ...
  subroutine Receive_PFT(this, fates_params)
    ...
    name = 'fates_seed_germ_can_openness_param'
    call fates_params%RetreiveParameterAllocate(name=name, &
         data=this%germ_can_openness_param)
  ...
  subroutine FatesReportPFTParams(is_master)
     ...
     if(debug_report .and. is_master) then
        ...
        write(fates_log(),fmt0) 'germ_can_openness_param = ',EDPftvarcon_inst%germ_can_openness_param
